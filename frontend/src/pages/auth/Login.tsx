    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-gradient-hero">
      ...
      <Card className="w-full max-w-md bg-[var(--bg-elevated)] border-[var(--border-subtle)] shadow-saffron-lg">
        <CardHeader className="space-y-1 text-center pb-8 border-b border-[var(--border-subtle)]">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#f5890a] to-[#e8b84b] shadow-lg shadow-[#f5890a]/40">
            <span className="font-display text-2xl font-bold text-[#1a1814]">R</span>
          </div>
        ...
        <CardContent className="pt-8 space-y-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/auth/forgot" className="text-xs text-[var(--saffron-400)] hover:underline">Forgot password?</Link>
              </div>
              <div className="relative">
                <Input 
          ...
          <div className="mt-4 text-center text-sm text-[var(--text-muted)]">
            ...
            <Link to="/auth/register" className="font-semibold text-[var(--saffron-400)] hover:underline">
              Sign up
            </Link>
          </div>
        </CardContent>
